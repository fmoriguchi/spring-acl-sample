...
@Transactional
@RestController
@RequestMapping("acls/user")
public class UserAclResource {

	private final AclPermissions permissions;

	@Autowired
	//public UserAclResource(@Qualifier("acl.permissions.user") AclPermissions permissions) {
	public UserAclResource(AclPermissions permissions) {
